...
A centralized configuration class for application settings.
"""
...
class Config:
    ...
    APP_NAME = "Redland Forge"
    APP_TAGLINE = "Distributed Build Orchestrator"
    HELP_TITLE = f"{APP_NAME} - Help"
    ...
    TIMING_CACHE_FILE = ".config/redland-forge/timing-cache.json"
