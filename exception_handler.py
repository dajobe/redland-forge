...
Provides consistent exception handling and user visibility across the build-tui application.
"""
...
class ExceptionHandler:
    """Centralized exception handling for the build-tui application."""
