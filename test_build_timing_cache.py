...
class TestBuildTimingCache(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cache = BuildTimingCache(
            cache_file_path=self.test_cache_file,
            retention_days=1
        )
    ...
    def test_load_cache_existing_file(self):
        ...
        test_data = {
            ...
            "hosts": {
                "test-host": {
                    ...
                    "total_builds": 5,
                    "average_times": {"configure": 10.0, "make": 20.0, "make_check": 5.0, "total": 35.0},
                    "recent_builds": []
                }
            }
        }
        ...
        self.assertEqual(loaded_cache.cache_data["hosts"]["test-host"]["total_builds"], 5)
    ...
    def test_get_progress_estimate_no_data(self):
        ...
        progress = self.cache.get_progress_estimate("progress-host", "unknown-step", 50.0)
        self.assertIsNone(progress)
    ...
    def test_cleanup_old_data(self):
        ...
        self.cache.cache_data["hosts"]["recent-host"] = {
            ...
            "total_builds": 1,
            "average_times": {"configure": 15.0, "make": 25.0, "make_check": 8.0, "total": 48.0},
            "recent_builds": []
        }
